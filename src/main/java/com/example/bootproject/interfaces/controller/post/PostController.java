...
public class PostController {
    ...
    @Operation(summary = "View all posts", description = "View all registered posts.", tags = {
        "posts"})
    ...
    @Operation(summary = "Post View", description = "Search for posts with a specific ID.", tags = {
        "posts"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Post Search", description = "Search for posts that meet the conditions.", tags = {
        "posts"})
    @GetMapping("/api/posts")
    public List<PostDetailDTO> searchPost(
        @Parameter(name = "PostSearch", description = "Search criteria") PostSearch search) {
    ...
    @Operation(summary = "Update post", description = "Edit the content of a specific post.", tags = {
        "posts"})
    @PutMapping("/api/posts/{postId}")
    public PostUpdateDTO updatePost(@PathVariable("postId") String uuid,
        @Valid @RequestBody PostRegistDTO postRegistDTO) {
    ...
    public void deletePost(@PathVariable("postId") String uuid,
        @RequestParam("deleteType") DeleteType deleteType) {
